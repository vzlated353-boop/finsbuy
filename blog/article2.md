...
mainContent:
  - id: what-is-qc
    title: What is QC?
    content: QC, or Quality Control, refers to the process of ensuring that products meet specific quality standards. In the context of FansBuy, it involves a thorough inspection of your purchased items at our warehouse before they are shipped internationally. This includes checking for defects, correct sizing, color accuracy, and overall condition against the product description.
  - id: why-qc-photos-matter
    title: Why QC Photos Matter
...
faq:
  - question: What if I find a defect in the QC photos?
    answer: If you find a defect or discrepancy in the QC photos, you can request an exchange or return through FansBuy. We will communicate with the seller on your behalf to resolve the issue before shipping.
  - question: Are QC photos always provided for every item?
    answer: Yes, FansBuy provides QC photos for all items purchased through our agent service, ensuring you have full visibility into your order before it leaves our warehouse.
